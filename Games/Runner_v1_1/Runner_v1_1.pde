...
void setup() {
  ...
  blocks.add(new Block(50, 500, 300, 50));
  blocks.add(new Block(150, 400, 300, 50));
  blocks.add(new Block(250, 300, 180, 50));
  blocks.add(new Block(350, 200, 140, 50));
  blocks.add(new Block(450, 500, 300, 50));
  blocks.add(new Block(350, 490, 300, 50));
  blocks.add(new Block(550, 360, 150, 50));
  blocks.add(new Block(750, 125, 120, 50));
  blocks.add(new Block(850, 500, 300, 50));
  blocks.add(new Block(1150, 400, 300, 50));
  blocks.add(new Block(1350, 300, 90, 50));
  blocks.add(new Block(950, 200, 60, 50));
}
...
class Player {
  ...
  void accelerate() {
    ...
    if (keyIsDown(UP) && vel.y==0 && onGround()) {
      System.out.println("Jump "+frameCount);
      acc.y -= 20;
    }
  }
